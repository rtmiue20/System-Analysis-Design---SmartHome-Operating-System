...
const Dashboard = () => {
    ...
    const menuItems = [
        ...
        { id: 'rooms', label: 'Phòng', icon: Layers },
        { id: 'automations', label: 'Tự động hóa', icon: Zap },
        { id: 'scenes', label: 'Ngữ cảnh', icon: Layers },
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                            {rooms.length > 0 ? (
                                rooms.map((room, index) => {
                                    ...
                                    return (
                                        <div key={rId} onClick={() => setActiveRoomFilter(rId)} className="relative h-60 rounded-3xl overflow-hidden group cursor-pointer shadow-sm hover:shadow-lg transition-shadow">
